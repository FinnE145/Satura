(function () {
    ...
    const accomToggle = document.getElementById('accommodations_enabled');
    ...
    function syncDefaultsNotice() {
        ...
        const showForAccom = accomDefaultsActive && accomToggle?.checked;
    ...
    function syncAccommodations() {
        const enabled = accomToggle?.checked;
        ...
        if (accomFieldsAllEmpty && userAccomDefaults) {
            ...
            if (fields.starting_player) fields.starting_player.value = String(userAccomDefaults.starting_player);
